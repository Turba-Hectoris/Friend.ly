...
export const UserEvent = ({ event, handleJoinEvent, displayedUser }) => {
  return (
    <div className="profile_event">
      <div className="profile_event_info" >
        ...
        {
          !displayedUser ? <button className="btn event_details_button" type='button' onClick={() => {handleEventDetails(event.eventID)}} > Event Details </button> :
          <button className="btn join_event_button" type='button' onClick={() => {handleJoinEvent(event.eventID)}} > Join Event </button>
        }
