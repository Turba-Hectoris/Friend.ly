...
class Homepage extends React.Component {
  ...
  render () {
    return (<div className="homepage"><div className="homepageHero"><span className="carousel">Make </span><span className="carousel makeWhat">{this.state.options[this.state.counter]}</span></div>
      ...
      <div style={{color: '#ffffff', fontFamily: "'Roboto', sans-serif", backgroundColor:'rgba(21, 116, 205, 1)', padding: '4px'}}>© Copyright 2018 Aaron Chan - Derrick Theodore - Jackie Wang - William Eichhold</div>
      </div>
